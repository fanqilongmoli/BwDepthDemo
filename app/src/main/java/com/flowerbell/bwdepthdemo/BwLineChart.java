...
public class BwLineChart extends LineChart {
    private IMarker mXMarker;

    public BwLineChart(Context context) {
        this(context, null);
    }

    public BwLineChart(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BwLineChart(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void init() {
        ...
        mRenderer = new BwLineChartRenderer(this, mAnimator, mViewPortHandler);
    }
...
//            if (mMarker instanceof LineChartYMarkerView) {
            BwLineChartYMarkerView yMarker = (BwLineChartYMarkerView) mMarker;
            BwLineChartXMarkerView xMarker = (BwLineChartXMarkerView) mXMarker;
