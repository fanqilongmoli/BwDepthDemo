 ...
 */
public class BwBubbleChartRenderer extends BarLineScatterCandleBubbleRenderer {

    public BubbleDataProvider mChart;

    public BwBubbleChartRenderer(BubbleDataProvider chart, ChartAnimator animator,
