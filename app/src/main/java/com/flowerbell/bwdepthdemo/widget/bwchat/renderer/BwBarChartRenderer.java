...
public class BwBarChartRenderer extends BarLineScatterCandleBubbleRenderer {
    ...
    public BwBarChartRenderer(BarDataProvider chart, ChartAnimator animator,
...
//                mRenderPaint.setColor(dataSet.getColor(j / 4));
                ...
                if (data == null || !(data instanceof KlineEntity)) {
                    mRenderPaint.setColor(dataSet.getColor(i));
                } else {
                    // TODO: 2018/2/11 修改颜色 可以参考
                    if (((KlineEntity) data).getClose() < ((KlineEntity) data).getOpen()) {
                        mRenderPaint.setColor(dataSet.getColors().get(1));
                    } else {
                        mRenderPaint.setColor(dataSet.getColors().get(0));
                    }

                    if (((KlineEntity) data).getClose() == 0f && ((KlineEntity) data).getOpen() == 0f) {
                        if (((KlineEntity) data).getVol() > 0) {
                            mRenderPaint.setColor(dataSet.getColors().get(0));
                        } else {
                            mRenderPaint.setColor(dataSet.getColors().get(1));
                        }
