...
public class BwCandleStickChartRenderer extends LineScatterCandleRadarRenderer {
    ...
    public BwCandleStickChartRenderer(CandleDataProvider chart, ChartAnimator animator,
