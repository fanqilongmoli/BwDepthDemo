...
public class BwScatterChartRenderer extends LineScatterCandleRadarRenderer {

    public ScatterDataProvider mChart;

    public BwScatterChartRenderer(ScatterDataProvider chart, ChartAnimator animator, ViewPortHandler viewPortHandler) {
